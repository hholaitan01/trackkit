...
function Endpoint({ method, path, desc }) {
  const colors = { POST: "#22c55e", GET: "#38bdf8", PATCH: "#fbbf24", DELETE: "#ef4444" };
  return (
    <div style={{
...
export default function DocsPage({ onNavigate }) {
  ...
  const h2 = { fontSize: 24, fontWeight: 800, color: "#f0f9ff", letterSpacing: "-0.02em", margin: "0 0 8px", paddingTop: 48 };
  const h3 = { fontSize: 17, fontWeight: 700, color: "#f0f9ff", margin: "28px 0 8px" };
  const p = { fontSize: 14, lineHeight: 1.8, color: "rgba(148, 163, 184, 0.65)", margin: "8px 0" };
  const note = {
